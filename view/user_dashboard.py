...
class UserDashboard(tk.Frame):
    ...
    def to_university_management(self):
        ...
        self.student_management = UniversityManagement(self.parent,
                                                       back_callback=self.restore_from_university_management)
        self.student_management.grid(row=0, column=0, sticky='nsew')
    ...
    def show_statistics(self):
        ...
        for idx, (icon, label, value, bg_color, hover_color) in enumerate(stats_data):
            ...
            text_label = tk.Label(card, text=label, font=("Arial", 13, "bold"), bg=bg_color, fg='white', wraplength=200,
                                  cursor='hand2')
            ...
            value_label = tk.Label(value_frame, text=str(value), font=("Arial", 36, "bold"), bg='white', fg=bg_color,
    ...
    def on_student_in_class_double_click(self, tree):
        ...
        def add_subject():
            ...
            # Chọn lớp học phần
            tk.Label(form_frame, text="Lớp học phần:", font=("Arial", 11, "bold"), bg='white').grid(row=0, column=0,
                                                                                                    sticky='w', pady=5)
            ...
            class_var = tk.StringVar()
            class_combo = ttk.Combobox(form_frame, textvariable=class_var, values=class_options, width=50,
                                       state='readonly')
            ...
            for idx, (label, field) in enumerate(score_labels, 1):
                tk.Label(form_frame, text=label, font=("Arial", 11, "bold"), bg='white').grid(row=idx, column=0,
                                                                                              sticky='w', pady=5)
